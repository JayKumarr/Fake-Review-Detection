 ...
 */
public class WordsToInteger {
    
    public static void main(String[] args) throws FileNotFoundException, IOException {
        File f = new File("E:\\yelpResData\\NEW EXPERIMENTS\\review_content.txt");
        PrintStream out = new PrintStream(new File(f.getParentFile(),"unigram_data_for_svm.csv"));
        PrintStream outVocab = new PrintStream(new File(f.getParentFile(),"unigram_vocab.csv"));
